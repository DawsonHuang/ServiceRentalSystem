package com.dawson.srs.config.admin;
/**
 * 用来配置拦截器的配置类
 */
...
import com.dawson.srs.interceptor.admin.AuthorityInterceptor;
import com.dawson.srs.interceptor.admin.AdminLoginInterceptor;
@Configuration
